...
public class DSP_RequestEmployeeList extends StringRequest {
    private Map<String, String> params;

    public DSP_RequestEmployeeList(String companyId, Response.Listener<String> listener) {
        super(Method.POST, ZF_RequestLogin.HTTP_REQUEST_URL, listener, null);

        params = new HashMap<>();
        params.put("operation", "getEmployeeList");
